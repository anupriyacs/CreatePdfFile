	...
	public class HomeController : Controller
    {
        ...
        public ActionResult CreateDocument1(PersonalDetails details)
        {
           ...
           // FileStreamResult fileStreamResult = new FileStreamResult(stream, "application/pdf");
			...
			FileStream imageStream = new FileStream("C:\\Users\\Dell E6520\\source\\repos3\\CreatePdfFile\\CreatePdfFile\\images\\a.jpg", FileMode.Open, FileAccess.Read);
